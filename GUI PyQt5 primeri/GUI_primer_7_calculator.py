...
class Ui_MainWindow(object):
    ...
    def press_it(self, pressed):
        if pressed == "C":
            ...
            # check if starts with zero and delate the zero
            if self.outputLabel.text() == "0":
                self.outputLabel.setText("")
            # concateante the pressed button with what was there previously 
